...
echo -e "\nxxxbuild linux-mips64el"
"$SELF_DIR"/mips64el.sh "${PWD}/$SDK_PATH/mips64el" "$1" || exit 1
...
tar -czf "${PROJECT_NAME}-mips-$1-${GIT_VERSION}.tar.gz" "$SDK_PATH"
rm -rf "$SDK_PATH"
